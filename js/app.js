//时间计算
function setTime() {
    var urodz = new Date("10/23/2023");//填写你们开始的时间 格式：月/日/年 例如：8/17/2020
    var now = new Date();
...
new Valine({
    el: '#vcomments',
    appId: 'YZTJb3TMYNSQVQ8VC387drMI-gzGzoHsz',//填写自己申请的id
    appKey: 'DIDCJysNZi1JwnV6k8IUOxtH',//填写自己申请的key
    placeholder: '说点什么吧…',
    enableQQ: 'true',
});
